...
if [ -f /mnt/etc/nixos/hardware-configuration.nix ]; then
    echo "Found existing hardware-configuration.nix, skipping partitioning..."
    echo "Assuming /mnt is already properly mounted."
else
    echo "No existing configuration found, proceeding with partitioning..."
